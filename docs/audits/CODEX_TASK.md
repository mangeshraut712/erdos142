...
- `CORE_AUXILIARY_IDENTITIES.md` (historical root README) — claimed auxiliary identities, rejected shortcuts, unresolved step
- `verification/scripts/verify_core.py` — exact rational finite checks
- `verification/results/verification.json` — last captured result
...
1. Read `CORE_AUXILIARY_IDENTITIES.md`, `verification/scripts/verify_core.py`, and `verification/results/verification.json`.
2. Run `python3 verification/scripts/verify_core.py` and record the output.
