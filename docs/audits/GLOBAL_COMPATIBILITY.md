...
Run `python3 verification/scripts/verify_compatibility.py`. The captured output is
`verification/results/compatibility_verification.json`. It checks 21 local laws, every occupancy
