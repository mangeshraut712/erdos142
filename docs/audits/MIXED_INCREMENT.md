...
Locally verified result: `python3 verification/scripts/verify_mixed.py` exits 0; captured in
`verification/results/mixed_verification.json`. The local target remains OPEN.
...
Small groups, exact, `verification/scripts/verify_mixed.py`:
