...
Verified: `verify_full_group_energy.py` checks singleton cells for
...
Run `python3 verify_full_group_energy.py`; output in
`full_group_energy_verification.json`. Exact rational checks: the
